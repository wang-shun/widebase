...
object candle {
  ...
  /** Plot candlestick into current axes.
   ...
   * @param close values
   * @param open values
   * @param color of candle
   * @param dates of candle
   * @param properties of candle
   *
   * @return plot handle
   */
  def apply(
  ...
  /** Plot candlestick into specific axes.
   *
   * @param axes handle
   * @param high values
   * @param low values
  ...
  def apply(
    ...
    renderer.setSeriesOutlinePaint(dataset.getSeriesCount - 1, color)
    renderer.setUseOutlinePaint(true)
    renderer.setUpPaint(Color.white)
    renderer.setDownPaint(color)
